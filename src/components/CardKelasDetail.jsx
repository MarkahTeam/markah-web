          ...
          <div className="flex flex-col">
            ...
            {type === 'premium' ?
              <div className="flex flex-row">
                <h5 className="text-black font-bold text-2xl mt-4 2xl:mt-20 2xl:ml-20 line-through">IDR {old_price}</h5>
                <h5 className="text-black font-semibold text-lg 2xl:ml-20 ">IDR {price}</h5>
              </div> :
              <div className="flex flex-row">
                <h5 className="text-black font-bold text-2xl mt-4 2xl:mt-20 2xl:ml-20 line-through"> IDR {old_price}</h5>
                <h5 className="text-black font-semibold text-lg 2xl:ml-20 ">FREE</h5>
              </div>
            }
